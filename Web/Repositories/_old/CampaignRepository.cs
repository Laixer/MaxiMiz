...
//    /// </summary>
//    internal sealed class CampaignRepository : RepositoryBase, ICampaignRepository
//    {
...
//        public async Task<IEnumerable<CampaignWithStats>> GetActiveAsync(int page = 0)
//        {
...
//        public async Task<IEnumerable<CampaignWithStats>> GetInactiveAsync(int page)
//        {
//            var query = new Query<ColumnCampaignWithStats>(
//                ColumnCampaignWithStats.Status,
//                Order.Ascending,
...
//        public async Task<IEnumerable<CampaignWithStats>> GetPendingAsync(int page)
//        {
...
//        public Task<IEnumerable<CampaignWithStats>> GetQueriedAsync(string query, ColumnCampaign column, Order order, int page = 0)
//        {
//            throw new NotImplementedException();
//        }
//    }
