...
using Maximiz.Transactions.Abstraction;
...
namespace Maximiz.Core.Transactions.Implementation
{
    ...
    /// </summary>
    internal class TransactionExecuter : ITransactionExecuter
    {
        ...
        public TransactionExecuter(ICudProcessor cudProcessor, ISender<Entity> sender)
        {
